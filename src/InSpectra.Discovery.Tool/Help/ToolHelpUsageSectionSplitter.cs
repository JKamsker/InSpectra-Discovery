...
{
    public static ToolHelpUsageSectionParts Split(IReadOnlyList<string> lines)
    {
        if (lines.Count == 0)
        {
            return ToolHelpUsageSectionParts.Empty;
        }
        ...
        return new ToolHelpUsageSectionParts(usageLines, argumentLines, optionLines);
    }
    ...
    {
        public static ToolHelpUsageSectionParts Empty { get; } = new([], [], []);
    }
