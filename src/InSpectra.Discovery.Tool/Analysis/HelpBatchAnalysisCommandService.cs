...
internal sealed class HelpBatchAnalysisCommandService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var snapshotLookup = HelpBatchAnalysisResultSupport.LoadCurrentSnapshotLookup(root);
        ...
        foreach (var item in plan.Items)
        {
            ...
            {
                skippedItems.Add(HelpBatchAnalysisResultSupport.CreateSkippedItem(
                    item,
        ...
        CancellationToken cancellationToken)
    {
        ...
        return HelpBatchAnalysisResultSupport.CreateOutcome(item, artifactName, itemOutputRoot, exitCode, snapshotLookup);
    }
}
