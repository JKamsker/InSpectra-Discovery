...
internal static class NonSpectreAnalysisResultSupport
{
    ...
    {
        var result = AnalysisResultSupport.CreateInitialResult(packageId, version, batchId, attempt, source, analyzedAt);
