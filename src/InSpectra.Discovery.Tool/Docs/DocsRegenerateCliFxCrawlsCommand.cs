...
internal sealed class DocsRegenerateCliFxCrawlsCommand : AsyncCommand<DocsRegenerateCliFxCrawlsCommand.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        return await output.WriteSuccessAsync(
            ...
            [
                ...
                new SummaryRow("CliFx crawl artifacts", result.CandidateCount.ToString()),
