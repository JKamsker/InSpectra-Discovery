...
internal sealed class DocsRegenerateXmldocOpenCliCommand : AsyncCommand<DocsRegenerateXmldocOpenCliCommand.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        return await output.WriteSuccessAsync(
            ...
            [
                ...
                new SummaryRow("XMLDoc-synthesized artifacts", result.CandidateCount.ToString()),
